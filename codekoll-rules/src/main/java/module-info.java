...
module io.codekoll.rules {
  ...
  provides io.codekoll.api.Rule with
      ...
      io.codekoll.rules.frameworks.ProxySelfInvokeRule,
      io.codekoll.rules.frameworks.EntityContractRule,
      io.codekoll.rules.frameworks.LogExceptionLostRule,
      ...
      io.codekoll.rules.modern.RecordMutableComponentRule,
      io.codekoll.rules.modern.StructuredGetBeforeJoinRule,
